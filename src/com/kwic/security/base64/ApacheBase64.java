...
// Source File Name:   ApacheBase64.java

package com.kwic.security.base64;

// Referenced classes of package com.kwic.security.base64:
//            SBinaryEncoder, SBinaryDecoder, SDecoderException, SEncoderException

public class ApacheBase64 implements SBinaryEncoder, SBinaryDecoder {
	...
	public Object decode(Object pObject) throws SDecoderException {
		if (!(pObject instanceof byte[])) {
			throw new SDecoderException("Parameter supplied to Base64 decode is not a byte[]");
		} else {
	...
	public Object encode(Object pObject) throws SEncoderException {
		if (!(pObject instanceof byte[])) {
			throw new SEncoderException("Parameter supplied to Base64 encode is not a byte[]");
		} else {
